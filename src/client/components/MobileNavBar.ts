      ...
      >
        ...
        >
          <div class="flex flex-col items-center gap-1">
            <img
              src=${assetUrl("images/YoinkLandLogo.svg")}
              alt="YoinkLand"
        ...
        <button
          class="nav-menu-item block w-full text-left font-bold uppercase tracking-[0.05em] text-amber-100/80 transition-all duration-200 cursor-pointer hover:text-yellow-300 hover:translate-x-2.5 hover:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] text-[clamp(18px,2.8vh,32px)] py-[clamp(0.2rem,0.8vh,0.75rem)] [&.active]:text-yellow-300 [&.active]:translate-x-2.5 [&.active]:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] ${currentPage ===
          "page-play"
            ? "active"
            : ""}"
          data-page="page-play"
        ...
        ></button>
        <div
          class="nav-menu-item hidden items-center w-full cursor-pointer"
          data-page="page-news"
          @click=${this._notifications.onNewsClick}
        >
          <button
            class="block text-left font-bold uppercase tracking-[0.05em] text-amber-100/80 transition-all duration-200 cursor-pointer hover:text-yellow-300 hover:translate-x-2.5 hover:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] [&.active]:text-yellow-300 [&.active]:translate-x-2.5 [&.active]:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] text-[clamp(18px,2.8vh,32px)] py-[clamp(0.2rem,0.8vh,0.75rem)]"
            data-i18n="main.news"
          ></button>
        ...
        ></button>
        <button
          class="no-crazygames nav-menu-item hidden w-full text-left font-bold uppercase tracking-[0.05em] text-amber-100/80 transition-all duration-200 cursor-pointer hover:text-yellow-300 hover:translate-x-2.5 hover:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] [&.active]:text-yellow-300 [&.active]:translate-x-2.5 [&.active]:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] text-[clamp(18px,2.8vh,32px)] py-[clamp(0.2rem,0.8vh,0.75rem)]"
          data-page="page-clan"
          data-i18n="main.clans"
        ></button>
        <!-- Sponsors (tap to expand) -->
        <details class="w-full">
          <summary
            class="block w-full text-left font-bold uppercase tracking-[0.05em] text-amber-100/80 cursor-pointer hover:text-yellow-300 text-[clamp(18px,2.8vh,32px)] py-[clamp(0.2rem,0.8vh,0.75rem)] list-none [&::-webkit-details-marker]:hidden"
          >
            Sponsors ▾
          </summary>
          <div class="flex flex-col pl-3 mt-1 gap-1">
            ${SPONSORS.map(
              (s) =>
                html`<a
                  href="${s.url}"
                  ...
                  class="text-amber-100/70 hover:text-yellow-300 transition-colors text-[clamp(14px,2vh,20px)] py-1"
                  >${s.name}</a
                >`,
            )}
          </div>
        ...
        <div
          class="no-crazygames nav-menu-item hidden items-center w-full cursor-pointer"
        ...
        ></button>
        <button
          class="no-crazygames nav-menu-item block w-full text-left font-bold uppercase tracking-[0.05em] text-amber-100/80 transition-all duration-200 cursor-pointer hover:text-yellow-300 hover:translate-x-2.5 hover:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] [&.active]:text-yellow-300 [&.active]:translate-x-2.5 [&.active]:drop-shadow-[0_0_20px_rgba(37,99,235,0.5)] text-[clamp(18px,2.8vh,32px)] py-[clamp(0.2rem,0.8vh,0.75rem)]"
