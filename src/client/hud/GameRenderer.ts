...
import { LandBridgeController } from "../controllers/LandBridgeController";
import { LiveStatsController } from "../controllers/LiveStatsController";
import { SellLandController } from "../controllers/SellLandController";
...
import { TrebuchetFireController } from "../controllers/TrebuchetFireController";
...
export function createRenderer(
  ...
  const uiState: UIState = {
    ...
    landBridgeMode: false,
    trebuchetAiming: false,
    sellLandMode: false,
  };
  ...
  const layers: Controller[] = [
    ...
    new LandBridgeController(game, eventBus, uiState, transformHandler),
    new TrebuchetFireController(game, eventBus, uiState, transformHandler),
    new SellLandController(game, eventBus, uiState, transformHandler),
