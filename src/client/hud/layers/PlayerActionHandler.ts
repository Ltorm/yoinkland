...
export class PlayerActionHandler {
  ...
  handleSurrender(vassal: PlayerView, lord: PlayerView) {
    this.eventBus.emit(new SendSurrenderIntentEvent(vassal, lord));
  }

  handleReleaseVassal(lord: PlayerView, vassal: PlayerView) {
    this.eventBus.emit(new SendReleaseVassalIntentEvent(lord, vassal));
  }
