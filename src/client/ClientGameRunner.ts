...
export class ClientGameRunner {
  ...
  private inputEvent(event: MouseUpEvent) {
    if (
      ...
      this.renderer.uiState.landBridgeMode || // left-click is placing a land bridge
      this.renderer.uiState.trebuchetAiming || // left-click released a trebuchet shot
      this.renderer.uiState.sellLandMode // drawing a sell-land lasso
    ) {
      return;
    }
