...
export type ReleaseVassalIntent = z.infer<typeof ReleaseVassalIntentSchema>;
...
export type BuildLandBridgeIntent = z.infer<typeof BuildLandBridgeIntentSchema>;
...
export const ReleaseVassalIntentSchema = z.object({
  type: z.literal("release_vassal"),
  vassal: ID,
});
...
export const BuildLandBridgeIntentSchema = z.object({
  type: z.literal("build_land_bridge"),
  // Anchor tile the segment grows from (an owned shoreline or bridge tip).
  startTile: z.number(),
  // Tile the player is aiming at; defines the segment's direction.
  targetTile: z.number(),
});

export const FireTrebuchetIntentSchema = z.object({
  type: z.literal("fire_trebuchet"),
  // The trebuchet unit firing.
  trebuchetId: z.number().int(),
  // Target tile the boulder is aimed at.
  targetTile: z.number(),
});
...
export const RespondLandSaleIntentSchema = z.object({
