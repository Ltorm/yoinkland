...
export class ServerEnv {
  ...
  // Self-host opt-out: skip server-side Turnstile verification entirely (which
  // otherwise calls the external api-worker). Set DISABLE_TURNSTILE=true when
  // running a private instance without that worker.
  static disableTurnstile(): boolean {
